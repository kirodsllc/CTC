...
export const PartsList = ({ parts = initialParts, onSelectPart }: PartsListProps) => {
  ...
  const filteredParts = useMemo(() => {
    ...
    return parts.filter((part) => {
      const mp = part.masterPartNo ? String(part.masterPartNo).toLowerCase() : "";
      return (
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/30">
              <TableHead className="font-bold text-foreground text-xs py-2">Part No</TableHead>
              <TableHead className="font-bold text-foreground text-xs py-2">Brand</TableHead>
              <TableHead className="font-bold text-foreground text-xs py-2">UOM</TableHead>
              <TableHead className="font-bold text-foreground text-xs py-2 text-right">Cost</TableHead>
              <TableHead className="font-bold text-foreground text-xs py-2 text-right">Price</TableHead>
              <TableHead className="font-bold text-foreground text-xs py-2 text-right">Stock</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
