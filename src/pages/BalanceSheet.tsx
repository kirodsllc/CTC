...
import { Calendar, Download, Printer, Settings, MoreVertical } from "lucide-react";
...
const BalanceSheet = () => {
  ...
  const renderMainGroup = (mainGroup: MainGroup, isAssets: boolean) => {
    return (
    ...
    <div className="h-screen flex bg-background overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden ml-16">
        ...
        <main className="flex-1 p-6 overflow-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="border-border/50">
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    {data.assets && data.assets.map((mainGroup) => renderMainGroup(mainGroup, true))}
                  </div>
              ...
              <Card className="border-border/50">
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2">
                    {data.liabilities && data.liabilities.map((mainGroup) => renderMainGroup(mainGroup, false))}
                  </div>
                  <Separator className="my-3" />
                  <div className="flex justify-between items-center py-2 font-bold">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="space-y-2">
                      {data.equity && data.equity.map((mainGroup) => {
                        ...
                        return renderMainGroup(mainGroup, false);
                      })}
                    </div>
          ...
          {/* Balance Check */}
          {data && (
            <div className={`mt-6 p-4 rounded-lg flex items-center justify-center gap-3 ${isBalanced ? 'bg-green-500/10 border border-green-500/20' : 'bg-red-500/10 border border-red-500/20'}`}>
              {isBalanced ? (
